...
**테스트 체크리스트**:
- [x] App Store Connect에서 샌드박스 테스트 계정 생성
- [ ] 샌드박스 테스트 계정으로 앱 로그인 테스트
- [x] 테스트용 무료 체험 기간 설정 (신규 구독 특가로 "첫 달 무료" 설정 완료)
- [ ] 결제 성공 플로우 테스트 (제품 승인 대기 중 - 승인 후 테스트 예정)
- [ ] 결제 실패 플로우 테스트
- [ ] 구독 취소 플로우 테스트
- [ ] 무료 체험 기간 만료 플로우 테스트
- [ ] 구독 갱신 플로우 테스트
...
**테스트 진행 상황**:
- **2025년 12월 18일**: 제품 승인 대기 중 상태 확인
  - App Store Connect에서 "Premium Monthly" 제품이 "유료계약 대기중" 또는 "승인 중" 상태
  - 제품 승인 완료 후 테스트 재시도 예정
  - 현재 문제: 제품 정보 로드 실패 (0개) - 제품 승인 대기 중이므로 정상

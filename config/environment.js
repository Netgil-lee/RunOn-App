...
const ENV = {
  ...
  prod: {
    ...
    kakaoMapApiKey: '464318d78ffeb1e52a1185498fe1af08', // JavaScript 키 (웹뷰용)
    kakaoRestApiKey: (Constants.expoConfig?.extra?.kakaoRestApiKey) || 
                    (Constants.manifest?.extra?.kakaoRestApiKey) || 
                    'e7407cb4e58959ce10a694d40c327641', // REST API 키 (Kakao Places API용)

...
const LoginScreen = ({ navigation }) => {
  ...
  const [agreeToTerms, setAgreeToTerms] = useState(false); // 이용약관 동의
  const [agreeToPrivacy, setAgreeToPrivacy] = useState(false); // 개인정보처리방침 동의
              ...
              {isSignupMode && (
                ...
                >
                  ...
                  <View style={styles.checkboxRow}>
                    ...
                    >
                      <Ionicons
                        name={agreeToTerms ? 'checkbox' : 'checkbox-outline'}
                        size={24}
                        color={agreeToTerms ? '#3AF8FF' : '#666'}
                      />
                    </TouchableOpacity>
                  ...
                  <View style={[styles.checkboxRow, styles.lastCheckboxRow]}>
                    ...
                    >
                      <Ionicons
                        name={agreeToPrivacy ? 'checkbox' : 'checkbox-outline'}
                        size={24}
                        color={agreeToPrivacy ? '#3AF8FF' : '#666'}
                      />
                    </TouchableOpacity>
                    <View style={styles.checkboxTextContainer}>
                      <View style={styles.checkboxLabel}>
                        <TouchableOpacity onPress={() => openModal('privacy')} style={styles.inlineLink}>
                          <Text style={styles.underlinedText}>개인정보처리방침</Text>
                        </TouchableOpacity>
                        <Text style={styles.checkboxText}>에 동의합니다</Text>
                        <Text style={styles.requiredText}> (필수)</Text>
                      </View>
